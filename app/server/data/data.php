...
$projects=[
	[
		...
		'type' => 'befejező szakipar/belsőépítészet  budapest xii.',
		...
		'description' => 'A nyitott szemléletű Megbízó minőségi és időtálló otthon megalkotását kérte. Sötét-világos kontrasztok, élettel teli tölgy,- és kőris felületek, élénk színű kiegészítők határozzák meg a belső teret.Az északi tájolás ellenére, fehér felületek használatával, fénnyel telt világos tér született.',
	],
	[
		'name' => 'klasszikus',
		'title' => 'klasszikus-modern lakás a vár oldalában',
		'type' => 'komplex szakipar/belsőépítészet  budapest i.',
		...
		'description' => 'Adott egy kétszintes lakás idejét múlt stílusban, festői kilátással a budai hegyekre, valamint hagyomány,- és értéktisztelő, haladó gondolkodású fiatal házaspár. Elképzelésük összetett feladatot adott – megmenteni, ami értékes, majd funkcionális szempontok alapján átalakítani, végül a Megrendelői igényekhez igazodva harmonikus enteriőrt alkotni. Egyedi igényeik figyelembevételével izgalmas, stíluskontrasztokkal kísért miliőt terveztünk.',
	],
	[
		'name' => 'iroda_es_oltozo_egyuttes',
		'title' => 'csarnokból átalakított iroda és öltöző együttes',
		'type' => 'komplex szerelő- és szakipar  budapest iii.',
	...
	[
		...
		'description' => 'Legtöbb részében felújított budai villa medence terének korszerűsítése volt a feladatunk. Belépve a tervezési területre az egy-két évtizede alkalmazott belsőépítészeti felfogás köszönt vissza. Megbízónk korszerű és minőségi átszabását kérte a térnek. Tervezés közben ésszerű keretek között nyúltunk a meglévő elemekhez. Az épületszerkezeteken csak oly mértékben változtattunk, hogy a végeredmény látványban teljesen újat, frisset nyújtson, a beruházás viszont ár-érték arányban azonos szinten legyen az épület többi részével. Kellemes és könnyed teret hoztunk létre.',
	],

	[
		'name' => 'body_shop',
		'title' => 'body shop üzlet felújítés és átalkítás',
		'type' => 'komplex szerelő és szakipar  budapest xi. Alle Bevásárló központ',
